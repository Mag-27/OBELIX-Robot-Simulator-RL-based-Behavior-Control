"""PPO trainer for OBELIX — matches lecture pseudocode exactly.
...
class PPO:
    ...
    def trainAgent(self):
        ...
        while True:
            self.rBuffer.fill(envs, self.pNetwork, self.vNetwork)
            self.trainNetworks()
...
def main():
    ...
    print(f"[train_ppo] Final eval score : {final_eval:+.2f}")
